...
#         return x #, emb_loss
    def __init__(self, image_in_channels=4, out_channels=4, init_weights=True,use_spectral_norm=True,mlp_dwconv=False,mlp_ratio=4,drop_path=0):
        ...
        self.encoder_firstthree = nn.Sequential(
            ...
            spectral_norm(nn.Conv2d(in_channels=64, out_channels=128, kernel_size=5, stride=2, padding=4,dilation=2),
                          use_spectral_norm),
            nn.InstanceNorm2d(128, track_running_stats=False),
            nn.ReLU(True),
        ...
        self.encoder_lastthree = nn.Sequential(
            ...
            spectral_norm(nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=2, padding=1),
                      use_spectral_norm),
            nn.InstanceNorm2d(512, track_running_stats=False),
            nn.ReLU(True)
